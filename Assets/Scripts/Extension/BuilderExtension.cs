...
namespace Test2DGame
{
    internal static partial class BuilderExtension
    {
        ...
        public static GameObject AddCircleCollider2D(this GameObject gameObject, float colliderRadius)
        {
            gameObject.GetOrAddComponent<CircleCollider2D>().radius = colliderRadius;
            return gameObject;
        }
